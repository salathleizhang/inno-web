...
export const heroHome: HeroProps = {
  title: (
    <>
      エンタ一プライス人エ AIソリュ一ション
    </>
  ),
  subtitle: (
    <>
      エンタープライズグレードのプライベートモデルの構築 | フルプロセス・ソリューション
    </>
  ),
  // callToAction: {
  //   text: 'Get template',
...
export const contentHomeOne: ContentProps = {
  ...
  content: 
      '生成AIの導入を戦略立案から実装、運用まで 一気通貫で支援します',
  items: [
    {
      title:
          '私達は生成AIを初めとする最新のIT技術に精通したプロ集団です。そんなInnoSphereだからこそ革新的で実用的なソリューションを低コストで実現することができます'
      // description:
