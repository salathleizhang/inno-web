...
export const features2Services: FeaturesProps = {
  ...
  header: {
    title: 'AI SaaS 事業',
    subtitle:
      'InnoSphereのSaaS事業は、生成AIを基軸としたSaaSプロダクトを提供いたします。',
    tagline: '02',
  },
  items: [
    {
      title: 'スケーラブルなソリューション',
      description: '企業の規模に応じて、簡単に拡張可能なAIツールを提供します。小規模から大規模企業まで、幅広く適用可能です。',
      icon: IconBrandTailwind,
    },
    {
      title: 'クラウドベースでの導入の容易さ',
      description: 'クラウド上で稼働するため、特別なハードウェアやITリソースの負担なく、迅速な導入と運用が可能です。',
      icon: IconComponents,
    },
    {
      title: '最新のAI技術の即時利用',
      description: '常に最新のAIアルゴリズムと機能が更新され、即時に利用できるため、企業は常に最先端の技術を活用できます。',
      icon: IconListCheck,
    },
    {
      title: 'セキュリティと信頼性',
      description: '業界最高水準のセキュリティ基準を満たす堅牢なインフラで、データの保護と信頼性を確保し、安心してAIソリューションを利用できます。',
      icon: IconRocket,
    },
  ],
};
...
export const features4Services: FeaturesProps = {
  ...
  header: {
    title: '提供するサービス',
    subtitle:
      'AI技術を用いて、人々の生活を向上させ、企業の効率を最適化するソリューションを提供します。',
